...
export const billiardsCues = [
  { id: 'house', name: 'Классика', url: new URL('./assets/house-cue.svg', import.meta.url).href },
  { id: 'ebony', name: 'Эбен и латунь', url: new URL('./assets/ebony-cue.svg', import.meta.url).href },
  { id: 'maple', name: 'Клён и бирюза', url: new URL('./assets/maple-cue.svg', import.meta.url).href },
] as const;
