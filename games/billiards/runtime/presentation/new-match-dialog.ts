...
const matchPicker = {
  title: 'Новая партия',
  notice: 'Американский — 8-ball: после любого фола соперник получает биток с руки, даже если биток не забит. Русский — клубная свободная пирамида: любой биток, свояки, до 8 шаров. Штрафной шар выбирает соперник. Упрощённый отыгрыш: контакт + борт; не турнирный регламент.',
  options: [
