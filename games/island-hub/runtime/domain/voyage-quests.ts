...
export interface VoyageQuest {
  ...
  readonly discoveries?: number; readonly islands?: number; readonly prerequisite?: string;
}
export const voyageQuests: readonly VoyageQuest[] = [
  ...
  { id: 'garden-shells', owner: 'mira', title: 'Море в цветочном саду',
    request: 'Хочу украсить клумбу ракушками. Принесёшь три? Они лежат на южном берегу и в Ракушечной бухте.',
